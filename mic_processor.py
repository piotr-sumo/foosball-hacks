...
class MicProcessor:
    ...
    def open_streams(self, rate = 44100, channels = 1, format = pyaudio.paFloat32, frames_per_buffer = 4096, input_host_api_specific_stream_info = None, stream_callback = None, circular_buffer_maxlen = 100):
